...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@400;700&family=Segoe+UI:wght@400;700&display=swap"
        rel="stylesheet">
    <style>
        body {
            margin: 0;
            padding: 0;
            font-family: <?php echo ($lang=='ar'? "'Cairo', sans-serif" : "'Segoe UI', sans-serif");
            ?>;
        }
    </style>
</head>
    ...
    <div class="login-wrapper">
        ...
        <div class="login-brand-side">
            <div class="text-center position-relative" style="z-index: 2;">
                <img src="<?php echo BASE_URL; ?>/assets/img/logo.png" alt="Basmat Rooq" class="brand-logo-img mb-4"
        ...
        <div class="login-form-side">
            ...
            <div class="login-form-container">
                <div class="mb-5">
                    ...
                    <p class="text-muted">
                        <?php echo ($lang == 'ar' ? 'يرجى إدخال بيانات الاعتماد الخاصة بك' : 'Please enter your credentials to access your dashboard.'); ?>
                    </p>
                </div>
