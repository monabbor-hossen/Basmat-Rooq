...
<!DOCTYPE html>
<html lang="<?php echo $lang; ?>" dir="<?php echo $isRTL ? 'rtl' : 'ltr'; ?>" class="scroll-smooth">
<head>
    <meta charset="UTF-8">
            ...
            <div class="flex justify-between items-center h-16 sm:h-20">
                ...
                <div class="flex items-center gap-3 sm:gap-4 z-50">
                    ...
                    <a href="<?php echo BASE_URL; ?>public/login.php"
                        ...
                        <span
                            class="text-[11px] sm:text-sm font-bold tracking-wider uppercase whitespace-nowrap"><?php echo $text['login']; ?></span>
                    </a>
                </div>
            </div>
        </div>
