...
<?php if ($_isLandingPage): ?>
    ...
    <body class="antialiased selection:bg-[#52ecc5] selection:text-[#01120c]">
        ...
        <nav class=" top-0 left-0 w-full z-[100] transition-all duration-300 nav-blur pt-3 pb-3 sm:pt-4 sm:pb-4">
                ...
                <div class="flex justify-between items-center h-16 sm:h-20">
                    ...
                    <div class="flex items-center gap-3 sm:gap-4 z-50">
                        ...
                        <a href="<?php echo BASE_URL; ?>public/login.php"
                            ...
                            <span
                                class="text-[11px] sm:text-sm font-bold tracking-wider uppercase whitespace-nowrap"><?php echo $text['login'] ?? 'Portal'; ?></span>
                        </a>
                    </div>
                </div>
            </div>
