...
?>
<!DOCTYPE html>
<html lang="<?php echo $lang; ?>" dir="<?php echo $isRTL ? 'rtl' : 'ltr'; ?>"<?php if ($_isLandingPage) echo ' class="scroll-smooth"'; ?>>
<head>
    <meta charset="UTF-8">
...
<body class="antialiased selection:bg-[#52ecc5] selection:text-[#01120c]">
    ...
    <div class="bg-orb w-[250px] sm:w-[500px] h-[250px] sm:h-[500px] bg-[#52ecc5] bottom-[-10%] right-[-10%]" style="animation-delay: -5s; opacity: 0.1;"></div>
    <div class="bg-orb w-[200px] sm:w-[400px] h-[200px] sm:h-[400px] bg-[#023020] top-[40%] left-[60%]" style="animation-delay: -10s;"></div>
            ...
            <div class="flex justify-between items-center h-16 sm:h-20">
                ...
                <a href="<?php echo BASE_URL; ?>" class="flex items-center gap-2 sm:gap-3 group z-50 flex-shrink-0">
                    <div class="relative flex items-center justify-center">
                        ...
                        <div class="absolute inset-0 bg-[#52ecc5] blur-xl opacity-0 group-hover:opacity-30 transition-opacity"></div>
                    </div>
                </a>
                ...
                <div class="flex items-center gap-3 sm:gap-4 z-50">
                    ...
                    <button id="translate-btn"
                        ...
                        title="<?php echo $lang === 'en' ? 'Translate to Arabic' : 'Translate to English'; ?>">
                        <i class="fa-solid fa-globe text-lg group-hover:drop-shadow-[0_0_8px_rgba(82,236,197,0.6)] transition-all"></i>
                    ...
                    <a href="<?php echo BASE_URL; ?>public/login.php"
                        ...
                        <span class="text-[11px] sm:text-sm font-bold tracking-wider uppercase whitespace-nowrap"><?php echo $text['login'] ?? 'Portal'; ?></span>
                    </a>
                </div>
            </div>
        </div>
