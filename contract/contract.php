...
if (!empty($client['t_n_reservation']) && $client['t_n_reservation'] !== 'Not Required') {
    $scopeList[] = "Trade Name Reservation";
}
if (!empty($client['cr_application']) && $client['cr_application'] !== 'Not Required') {
    $scopeList[] = "CR Application & Registration";
}
...
$serviceProvider = $globalDefaults['service_provider'] ?? 'Fayenor Company';
$providerEmail = $globalDefaults['provider_email'] ?? 'info@fayenor.com';
...
<a href="edit_contract?id=<?php echo $client_id; ?>" class="edit-btn" data-html2canvas-ignore="true">✏️ Edit
    Contract</a>
    ...
    <div class="document-page">
        <div class="content">
            ...
            <p>The Total professional service fee for this Agreement is <strong>SAR
                    <?php echo htmlspecialchars($serviceFee); ?> (Saudi Riyals
                    <?php echo htmlspecialchars($serviceFeeWords); ?> Only)</strong>.</p>

            <p><em style="color:red;">Note: All kind of Service provide by
                    <?php echo htmlspecialchars($serviceProvider); ?> & All kind
            ...
            <div class="layout-table">
                ...
                <div style="display:flex; align-items: flex-end; margin-bottom: 10px;">
                    ...
                    <?php if ($signatureImage): ?>
                        <div
                            style="border-bottom: 1px solid var(--text-dark); width: 25%; text-align: center; padding-bottom: 2px;">
                            <img src="../assets/img/signatures/<?php echo htmlspecialchars($signatureImage); ?>"
